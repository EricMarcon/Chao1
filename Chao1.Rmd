...
L'estimation est bonne tant que l'inventaire n'est pas trop sous-échantilonné. Règle au doigt mouillé : pas plus d'un tiers des espèces observées une seule fois. Au-delà: sous estimation importante.